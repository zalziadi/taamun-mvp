...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  onContinue,
  userAvatarSrc = 'https://via.placeholder.com/32',
}) => {
    ...
    >
      ...
      <div className="fixed bottom-24 left-0 w-full px-6 pointer-events-none">
        <button
          ...
          className="pointer-events-auto w-full max-w-md mx-auto flex items-center justify-center gap-3 bg-[#e6d4a4] text-[#3a2f0d] py-5 rounded-xl font-serif text-lg font-bold shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all duration-300"
          style={{
