...
const STEPS = [
  ...
  { n: "٣", title: "سؤال التأمل", desc: "سؤال عميق يربط الآية بحياتك ويفتح لك زاوية جديدة." },
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                { icon: "edit_note", title: "دفتر التأمل", sub: "", desc: "دفتر شخصي يحفظ تأملاتك وخواطرك طوال الرحلة — ترجع لها وتشوف كيف تغيّرت نظرتك.", featured: false },
              ].map((feat, i) => (
