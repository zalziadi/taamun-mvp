...
const DAYS = [
  ...
  },
  {
    ...
    body: [
      ...
      "تخيّل نفسك بعد شهرٍ من التأمل المنتظم: ما أول عادةٍ تريد أن تثبتها؟",
...
function IconMoon() {
  return (
    <svg className="h-8 w-8 text-[#8c7851]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden>
    ...
    <div className="tm-shell space-y-10 pb-24">
      ...
      <section className="space-y-6">
          ...
          {DAYS.map((d, i) => (
            <button
              ...
              className={[
                ...
                day === d.id
                  ? "border-[#8c7851] bg-[#e9ddc6] text-[#5a4531]"
                  : "cursor-pointer border-[#ded4c2] bg-[#fcfaf7] text-[#5f5648] hover:border-[#8c7851]/40",
              ].join(" ")}
            >
        ...
        <article className="tm-card p-7 sm:p-8" role="tabpanel">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-xs font-medium text-[#8c7851]">{active.subtitle}</p>
              <h3 className="tm-heading mt-1 text-2xl text-[#2f2619]">{active.title}</h3>
              <div className="mt-5 space-y-4 text-sm leading-relaxed text-[#5f5648]/92 sm:text-[15px]">
      ...
      <section className="tm-card border-[#8c7851]/30 bg-[#fcfaf7] p-8 sm:p-10">
        ...
        <p className="mt-4 max-w-[760px] text-sm leading-relaxed text-[#5f5648]/90 sm:text-[15px]">
          ...
          التأمل العميق، والدفتر، والمرشد، ومدينة المعنى، وتحليلات الرحلة تظلُّ خلف بابٍ يفتحه اشتراكٌ يتناسب معك.
        </p>

        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-[#ded4c2] bg-[#fffefb] p-5">
            <h3 className="tm-heading text-xl text-[#5a4531]">أساسي</h3>
            <p className="mt-2 text-2xl font-bold text-[#2f2619]">٨٢ <span className="text-base font-semibold text-[#7b694a]">ريالًا شهريًا</span></p>
            <p className="mt-2 text-xs text-[#7d7362]">تأمل، دفتر، مصادر قرآنية — بداية منتظمة.</p>
          </div>
          <div className="rounded-2xl border border-[#8c7851]/35 bg-[#f4ead7]/60 p-5 ring-1 ring-[#8c7851]/15">
            <h3 className="tm-heading text-xl text-[#5a4531]">كامل</h3>
            <p className="mt-2 text-sm font-semibold text-[#2f2619]">باقة موسّعة للرحلة</p>
          ...
          <div className="rounded-2xl border border-[#ded4c2] bg-[#fffefb] p-5">
            ...
            <p className="mt-2 text-2xl font-bold text-[#2f2619]">٨٢٠٠ <span className="text-base font-semibold text-[#7b694a]">ريالًا</span></p>
