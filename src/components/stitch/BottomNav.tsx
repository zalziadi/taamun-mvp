...
import { JOURNAL_ROUTE, JOURNEY_ROUTE } from "@/lib/routes";
...
export const BottomNav: React.FC<BottomNavProps> = ({ active = "journey" }) => {
  ...
  return (
    <nav className="pb-safe fixed bottom-0 z-50 flex h-20 w-full flex-row-reverse items-center justify-around rounded-t-2xl border-t border-[#c9b88a]/10 bg-[#080705]/80 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] backdrop-blur-2xl">
      <Link href={JOURNEY_ROUTE}>
        <button
          type="button"
          className={`flex flex-col items-center justify-center transition-all duration-700 ease-out ${
            isActive("journey")
              ? "scale-110 font-bold text-[#e6d4a4]"
        ...
        >
          ...
          <span className="mt-1 font-sans text-[10px] uppercase tracking-[0.05rem]">رحلتي</span>
        </button>
      </Link>
      ...
      <Link href="/progress">
        ...
        >
          ...
          <span className="mt-1 font-sans text-[10px] uppercase tracking-[0.05rem]">التقدم</span>
        </button>
      </Link>
      ...
      <Link href={JOURNAL_ROUTE}>
        ...
        >
          ...
          <span className="mt-1 font-sans text-[10px] uppercase tracking-[0.05rem]">دفتري</span>
        </button>
      </Link>
      ...
      <Link href="/account">
        ...
        >
          ...
          <span className="mt-1 font-sans text-[10px] uppercase tracking-[0.05rem]">حسابي</span>
        </button>
      </Link>
    </nav>
  );
