...
- [ ] 16. كود صالح يفعّل مرة واحدة — TAAMUN001 يعمل، ثم إعادة الاستخدام تعرض "مستخدم مسبقًا"
- [ ] 17. الأدمن يولد كودًا جديدًا — لوحة الأدمن في /activate
- [ ] 18. الأدمن ينسخ رابط التفعيل — زر "نسخ رابط التفعيل" بجانب كل كود
