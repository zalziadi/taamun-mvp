...
echo "🔧 كتابة الملف المصحّح..."

cat > src/app/api/admin/dashboard/route.ts << 'ENDOFFILE'
...
echo "💾 git commit..."
git commit -m "fix(ts): resolve implicit any in admin dashboard route"

echo "🚀 git push..."
git push origin main

echo ""
echo "✅ تم! Vercel سيبني تلقائياً."
